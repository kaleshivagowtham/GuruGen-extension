...
export default function ChatBotSavitri ({ready, url}) {
    ...
    const questionHandler = async () => {
        ...
        const app = await client("https://614d2151b91b988449.gradio.live/");
        const result = await app.predict("/predict", [		
    ...
    return (
        <div className='chatBotWholeContExpand'>
            <div className='chatBotTopCont'>
                {/* <p className='chatBotTitle'>Ai Savitri</p> */}
                {/* <img src={expand ? shrinkIcon : expandIcon} 
                    className='chatBotExpandIcon'
                    onClick={expandHandler}
                /> */}
            </div>
            <div className='chatBotBottomContExpand' >
                ...
                {!ready
                    ?
                <div className='chatBotAskContExpand'>
